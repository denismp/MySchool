...
privileged aspect Student_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Student.fieldNames4OrderClauseFilter = java.util.Arrays.asList("quarters", "previousTranscripts", "graduateTracking", "guardians", "faculty", "schools");
