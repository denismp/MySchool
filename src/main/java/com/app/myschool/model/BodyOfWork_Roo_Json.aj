...
privileged aspect BodyOfWork_Roo_Json {
    ...
    public static BodyOfWork BodyOfWork.fromJsonToBodyOfWork(String json) {
        return new JSONDeserializer<BodyOfWork>().use(null, BodyOfWork.class).deserialize(json);
    }
    ...
    public static Collection<BodyOfWork> BodyOfWork.fromJsonArrayToBodyOfWorks(String json) {
        return new JSONDeserializer<List<BodyOfWork>>().use(null, ArrayList.class).use("values", BodyOfWork.class).deserialize(json);
    }
