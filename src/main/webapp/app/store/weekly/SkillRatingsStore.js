/*
 * File: app/store/weekly/SkillRatingsStore.js
 *
...
Ext.define('MySchool.store.weekly.SkillRatingsStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'MySchool.model.weekly.SkillRatingsModel',
    ...
    onJsonpstoreLoad: function(store, records, successful, eOpts) {
        //debugger;
        console.log("weekly.SkillRatingsStore.onJsonstoreLoad() called...");
    },

    onJsonpstoreWrite: function(store, operation, eOpts) {
        //debugger;
        console.log("weekly.SkillRatingsStore.onJsonstoreWrite(): called...");
        store.reload();
    }
